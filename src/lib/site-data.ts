...
export const changelog: ChangelogLine[] = [
  ...
  { type: "plus", text: "FRP vía Download Mode" },
  ...
  { type: "plus", text: "FRP Remove · Factory Reset · Erase PayJoy" },
  ...
  { type: "plus", text: "Activate ADB y PayJoy Remove" },
  ...
  { type: "plus", text: "Erase PayJoy MDM" },
  { type: "plus", text: "Factory Reset Secure" },
  { type: "blank" },
  ...
  { type: "plus", text: "Passcode Support para iOS 18.0 a 26.6" },
