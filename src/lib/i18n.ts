...
export const localeOptions = [
  ...
  { code: "pt-br" as const, label: "Português (Brasil)", short: "PT", flag: "🇧🇷" },
];
...
export const localeCopy = {
  es: {
    ...
    hero: {
      kicker: "Software moderno",
      titleAccent: "Herramienta profesional para ti.",
      description: "Una herramienta moderna diseñada para técnicos como tú",
      platform: "Windows",
    ...
    pricing: {
      ...
      title: "Elige tu plan",
      description: "Nuestras actualizaciones siempre son gratuitas. Accede a cada versión con una licencia ArepaTool activa.",
      popular: "Más elegido",
      price: "Precio /",
    ...
    updates: {
      title: "Registro de cambios de ArepaTool.",
    ...
    tutorials: {
      ...
      videoTitle: "Reproductor de video de YouTube",
    },
    instructions: {
    ...
    resellers: {
      ...
      resellers: "Distribuidores oficiales",
    ...
    models: {
      ...
      operations: { unlock: "Desbloquear BL", frp: "FRP de Android", tempUnlock: "Desbloqueo temporal BL" },
      transsionDescription: "Parches de ROM por Fastboot y operaciones Meta para dispositivos Transsion.",
      syncing: "Sincronizando ROM Patch…",
      romSupport: "Parche de ROM vía Fastboot",
      tested: "ROMs completamente probadas",
      ...
      romEmpty: "Aún no hay parches de ROM publicados con esa búsqueda.",
      meta: "Operaciones vía Meta",
      metaDescription: "FRP, restablecimiento de fábrica y PayJoy disponibles en modo Meta.",
      metaEmpty: "No encontramos modelos Meta con esa búsqueda.",
      model: "Modelo",
    },
    footer: {
      support: "Soporte",
      supportText: "Nuestro equipo de soporte está listo para ayudarte con tus preguntas o comentarios. El personal responderá los correos en un plazo de 24 horas. El idioma oficial del soporte es el inglés.",
      useful: "Enlaces útiles",
      account: "Mi cuenta",
      download: "Descargar módulos",
      downloadText: "Accede a tu cuenta para descargar los módulos más recientes de ArepaTool.",
      downloadAction: "Ir a descargas",
      login: "Iniciar sesión",
      signup: "Crear cuenta",
      forgot: "Olvidé mi contraseña",
      contact: "Contacto",
      copyright: "Desarrollado por ArepaTool Developers · Todos los derechos reservados · © 2026",
...
export const featureCopy: Record<Locale, { quick: string[]; groups: FeatureGroupCopy[]; note: string }> = {
  es: {
    ...
    groups: [
      ...
      { eyebrow: "Samsung 2026", title: "Modo de descarga Exynos", bullets: ["Todos los procesadores Exynos soportados.", "FRP desde el modo de descarga.", "Flasheo mediante Odin.", "Compatibilidad con seguridades inferiores a 05/2026."] },
      { eyebrow: "Motorola MediaTek", title: "FRP y bootloader", bullets: ["FRP y desbloqueo de bootloader para dispositivos Motorola MediaTek.", "Soporte para la gran mayoría de equipos Motorola 2025 y 2026.", "Versiones de Android 11, 12, 13, 14, 15 y 16."] },
      { eyebrow: "Transsion", title: "Infinix · Itel · Tecno", bullets: ["Protocolo Meta para FRP, restablecimiento de fábrica y bypass de PayJoy.", "Fastboot para escribir ROMs modificadas.", "LK Editor para desbloqueo de bootloader en AARCH64 y ARM32.", "Soporte para plugin de seguridad y anticrack."] },
      { eyebrow: "Unisoc Transsion", title: "Restablecimiento y PayJoy", bullets: ["Unisoc para Infinix, Itel y Tecno.", "Restablecimiento de fábrica y PayJoy con seguridades inferiores a 09/2026.", "Protocolo vía diagnóstico para puertos cerrados.", "FRP y restablecimiento de fábrica en dispositivos compatibles."] },
      ...
      { eyebrow: "ZTE · Nubia 2026", title: "Diagnóstico y restablecimiento", bullets: ["FRP y restablecimiento de fábrica para ZTE y Nubia compatibles.", "Protocolo de diagnóstico para puertos cerrados.", "Operaciones Unisoc en modelos 2026."] },
      { eyebrow: "Bloqueos MDM · DNS", title: "Bloqueos corporativos", wide: true, bullets: ["IT Admin, Kiosk, Claro y Telcel.", "White Screen y bloqueos Oppo.", "Métodos DNS y sin DNS.", "ADB sin relock.", "Método QR para equipos que piden Wi-Fi al iniciar.", "ArepaHotspot para editar la red inalámbrica y configurar el equipo sin riesgo de relock."] },
      { eyebrow: "Apple iOS", title: "Bypass y código de acceso", wide: true, bullets: ["Bypass Hello hasta iOS 26.1 en iPhone 11 hasta 17 Pro Max compatibles.", "A12 y A13: bypass de código de acceso y Hello.", "Operaciones sin créditos en los métodos compatibles."] },
    ],
